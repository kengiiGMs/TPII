...
Escopo: Programa que cria uma pizza personalizavel (Decorator).
Cria a pizza base, e adiciona elementos bases e elementos extras. Um metodo chamado custo() soma o preços 
e de todos os componentes adicionados, por fim retorna o preço total.Um metodo chamado getDescricao() retorna 
todas a descricao do elementos da pizza
--------------------------------------------------------------------------------------------------
*/
